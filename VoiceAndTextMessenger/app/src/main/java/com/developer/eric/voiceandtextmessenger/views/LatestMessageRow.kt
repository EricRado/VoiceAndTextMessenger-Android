...
class LatestMessageRow(val chatMessage: ChatMessage): Item<ViewHolder>() {
    ...
    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.textViewMessageLatestMessageRow.text = chatMessage.text
        ...
        ref.addListenerForSingleValueEvent(object: ValueEventListener {
            override fun onDataChange(p0: DataSnapshot) {
                ...
                viewHolder.itemView.textViewUsernameLatestMessageRow.text = chatPartnerUser?.username

                val targetImageView = viewHolder.itemView.imageViewLatestMessageRow
